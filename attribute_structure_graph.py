...
target_features = cat_structure_information(target_features,target_graph,matrix)
# cosine similarity
...
# plt.savefig('C:/Users/Chen/Desktop/3.14-3.17/citeseer_cat_dis.png')
# plt.figure(2)
# sns.heatmap(matrix,vmax=1,square=True)
# plt.savefig('C:/Users/Chen/Desktop/3.14-3.17/citeseer_cat_adj.png')