...
def load_dblp_data(target_graph,train_size,test_size):
    ...
    for i in range(train_size):
        ...
        while (1):
            ...
            sample_nodes = random.sample(connected_component_nodes, int(nodes_number * 0.67))
            ...
            subsubgraph = nx.k_core(subgraph, k=int(min_coreness * 0.67))
            ...
            subsubgraph = nx.k_core(subsubgraph, k=int(min_coreness * 0.63))
            if nx.number_of_nodes(subsubgraph) == 0:
                continue
            # public
    ...
    dgl.save_graphs('/mnt/HDD/crh/dblp/for_train_dblp/0.1/for_train_dblp_target_0_2.bin',all_target_graph)
    dgl.save_graphs('/mnt/HDD/crh/dblp/for_train_dblp/0.1/for_train_dblp_query_0_2.bin',all_query_graph,graph_labels)
    print('save done')
    ...
    graph_labels = {'glabel': torch.tensor(all_labels)}
    dgl.save_graphs('/mnt/HDD/crh/dblp/for_test_dblp/0.1/for_test_dblp_target_0_2.bin',all_target_graph)
    dgl.save_graphs('/mnt/HDD/crh/dblp/for_test_dblp/0.1/for_test_dblp_query_0_2.bin',all_query_graph,graph_labels)
    print('save done')
