...
def load_cora_data(train_size, test_size):
    ...
    target_size = raw_data.shape[0]  # 样本点数2708
    ...
    for i in range(train_size):
        ...
        while (1):
            ...
            if nodes_number >= 10:
                sample_nodes = random.sample(connected_component_nodes, int(nodes_number * 0.7))
            elif 5 < nodes_number < 10:
                sample_nodes = random.sample(connected_component_nodes, int(nodes_number * 0.9))
            elif nodes_number <= 5:
    ...
    torch.save(fin_target_features, './dataset/for_train_cora/0_2/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_train_cora/0_2/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_train_cora/0_2/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_train_cora/0_2/query_adj.pt', pickle_protocol=pickle_protocol)
    torch.save(fin_labels, './dataset/for_train_cora/0_2/labels.pt', pickle_protocol=pickle_protocol)
    ...
    torch.save(fin_target_features, './dataset/for_test_cora/0_2/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_test_cora/0_2/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_test_cora/0_2/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_test_cora/0_2/query_adj.pt', pickle_protocol=pickle_protocol)
    torch.save(fin_labels, './dataset/for_test_cora/0_2/labels.pt', pickle_protocol=pickle_protocol)
