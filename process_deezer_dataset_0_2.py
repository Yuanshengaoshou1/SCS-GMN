...
def load_deezer_data(train_size, test_size):
    ...
    for i in range(train_size):
        ...
        # ssave_graphs(path, [D_target, D_query], graph_labels)
    ...
    torch.save(fin_target_features, './dataset/for_train_deezer/0_2/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_train_deezer/0_2/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_train_deezer/0_2/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_train_deezer/0_2/query_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_labels, '.dataset/for_train_deezer/0_2/labels.pt', pickle_protocol=pickle_protocol)
    ...
    #     if all_sampled_k[sampled_number[0]] == 9 or all_sampled_k[sampled_number[0]] == 10 :
    ...
    torch.save(fin_target_features, './dataset/for_test_deezer/0_2/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_test_deezer/0_2/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_test_deezer/0_2/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_test_deezer/0_2/query_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_labels, './dataset/for_test_deezer/0_2/labels.pt', pickle_protocol=pickle_protocol)
