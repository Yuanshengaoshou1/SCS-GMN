...
def load_cora_data(train_size,test_size,train_path,test_path):
    ...
    for i in range(train_size):
        ...
        while (1):
            ...
            if nx.is_connected(subsubgraph) and flag:
                print('nx.nodes(subsubgraph)',nx.nodes(subsubgraph))
                print('nx.nodes(subsubgraph)',subsubgraph.nodes())
    ...
    # dgl.save_graphs('/mnt/HDD/crh/cora/for_train_cora/0.1/for_train_cora_target.bin',all_target_graph)
    # dgl.save_graphs('/mnt/HDD/crh/cora/for_train_cora/0.1/for_train_cora_query.bin',all_query_graph,graph_labels)
    print('save done')
    ...
    graph_labels = {'glabel': torch.tensor(all_labels)}
    dgl.save_graphs('/mnt/HDD/crh/cora/for_test_cora/0.1/more_test_samples/for_test_cora_target_4.bin',all_target_graph)
    dgl.save_graphs('/mnt/HDD/crh/cora/for_test_cora/0.1/more_test_samples/for_test_cora_query_4.bin',all_query_graph,graph_labels)
    print('save done')
