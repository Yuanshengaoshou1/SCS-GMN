...
def load_deezer_data(train_size, test_size):
    ...
    # dgl.save_graphs('/mnt/HDD/crh/deezer/for_train_deezer/0.1/for_train_deezer_target.bin',all_target_graph)
    # dgl.save_graphs('/mnt/HDD/crh/deezer/for_train_deezer/0.1/for_train_deezer_query.bin',all_query_graph,graph_labels)
    print('save done')
    ...
    graph_labels = {'glabel': torch.tensor(all_labels)}
    dgl.save_graphs('/mnt/HDD/crh/deezer/for_test_deezer/0.1/more_test_samples/for_test_deezer_target_10.bin',all_target_graph)
    dgl.save_graphs('/mnt/HDD/crh/deezer/for_test_deezer/0.1/more_test_samples/for_test_deezer_query_10.bin',all_query_graph,graph_labels)
    print('save done')
