...
def load_pubmed_data(train_size, test_size):
    ...
    for i in range(train_size):
        ...
        while (1):
            ...
            if nodes_number > 30:
                sample_nodes = random.sample(connected_component_nodes, int(nodes_number * 0.55))
    ...
    torch.save(fin_target_features, './dataset/for_train_pubmed/0_3/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_train_pubmed/0_3/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_train_pubmed/0_3/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_train_pubmed/0_3/query_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_labels, './dataset/for_train_pubmed/0_3/labels.pt', pickle_protocol=pickle_protocol)
    ...
    torch.save(fin_target_features, './dataset/for_test_pubmed/0_3/target_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_target_adjs, './dataset/for_test_pubmed/0_3/target_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_features, './dataset/for_test_pubmed/0_3/query_features.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_query_adjs, './dataset/for_test_pubmed/0_3/query_adj.pt',
               pickle_protocol=pickle_protocol)
    torch.save(fin_labels, './dataset/for_test_pubmed/0_3/labels.pt', pickle_protocol=pickle_protocol)
