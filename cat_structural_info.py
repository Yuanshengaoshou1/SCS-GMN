...
def cat_structural_information(train_target_features,train_target_adj,train_query_features,train_query_adj,data_path):
    pickle_protocol = 4
    ...
    #save file
    torch.save(fin_target_features_cat_degree, data_path +'nor_target_features_cat_degree_cluster_h_index_coreness.pt',pickle_protocol=pickle_protocol)
    torch.save(fin_query_features_cat_degree, data_path + 'nor_0.7_query_features_cat_degree_cluster_h_index_coreness.pt',pickle_protocol=pickle_protocol)
